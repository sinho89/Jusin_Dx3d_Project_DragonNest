...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	m_MainSplitter.CreateView(0, 0, RUNTIME_CLASS(CNaviForm), CSize(200, 600), pContext);
	m_MainSplitter.CreateView(0, 1, RUNTIME_CLASS(CToolView), CSize(WINCX, WINCY), pContext);

	RecalcLayout();

	m_pNaviForm	= (CNaviForm*)m_MainSplitter.GetPane(0, 1);
	m_pMainView	= (CToolView*)m_MainSplitter.GetPane(0, 0);
