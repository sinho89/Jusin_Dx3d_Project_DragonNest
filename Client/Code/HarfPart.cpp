...
CHarfPart::CHarfPart(LPDIRECT3DDEVICE9 pDevice)
: CParticle(pDevice)
...
CHarfPart* CHarfPart::Create(LPDIRECT3DDEVICE9 pDevice)
{
	CHarfPart*		pPetal = new CHarfPart(pDevice);
...
HRESULT CHarfPart::SetConstantTable(void)
{
...
HRESULT CHarfPart::AddComponent(void)
{
...
HRESULT CHarfPart::Initialize(void)
{
	AddComponent();
...
void CHarfPart::SetAni(BOOL bAni/*=TRUE*/)
{
	m_bAni = bAni;
...
void CHarfPart::SetAvgTime(FLOAT fTime)
{
	m_fTimeAvg = fTime;
}

void CHarfPart::SetPart(int nIdx)
{
	...
	pPrt->m_dColor	=	D3DXCOLOR(0.5f, 0.5f, 0.5f, pPrt->m_fLife);
