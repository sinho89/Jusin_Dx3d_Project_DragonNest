...
CCresentPart::CCresentPart(LPDIRECT3DDEVICE9 pDevice)
: CParticle(pDevice)
...
CCresentPart::~CCresentPart()
{

}
CCresentPart* CCresentPart::Create(LPDIRECT3DDEVICE9 pDevice)
{
	CCresentPart*		pPetal = new CCresentPart(pDevice);
...
HRESULT CCresentPart::SetConstantTable(void)
{
...
HRESULT CCresentPart::AddComponent(void)
{
...
HRESULT CCresentPart::Initialize(void)
{
	AddComponent();
...
void CCresentPart::SetAni(BOOL bAni/*=TRUE*/)
{
	m_bAni = bAni;
...
void CCresentPart::SetAvgTime(FLOAT fTime)
{
	m_fTimeAvg = fTime;
}

void CCresentPart::SetPart(int nIdx)
{
...
void CCresentPart::Release(void)
{
